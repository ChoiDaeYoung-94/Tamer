...
| Data safety·개인정보처리방침·계정 삭제/보관 | PR132 재인증·확인·조회·취소 core/SQLite 서버, PR133 설정 UI와 실제 렌더 검증. 기본 운영 비활성. C# 합성 loopback HTTP 어댑터와 실제 Python 소켓 계약13/13 검증 | 운영자·연락처·삭제 URL·범위·보관/재가입/No Ads 정책 결정, 운영 인증/HTTP/provider 연결과 실제 처리 검증·게시 |

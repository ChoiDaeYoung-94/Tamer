...
| --- | --- | --- |
| 자체 C# 전체 감사·리팩토링 | PR119–129 및 삭제 core/UI PR132–133 통합, 파일별 감사 112개·meta 누락0. 최신 삭제 포함 Editor355/355 | 실전투·포획·사망 등 아직 실행하지 않은 기기 경계를 별도 검증; 신규 코드마다 감사 목록 유지 |
...
| Data safety·개인정보처리방침·계정 삭제/보관 | PR132 재인증·확인·조회·취소 core/SQLite 서버, PR133 설정 UI와 실제 렌더 검증. 기본 운영 비활성, 합성 처리만 실행 | 운영자·연락처·삭제 URL·범위·보관/재가입/No Ads 정책 결정, 운영 인증/HTTP/provider 연결과 실제 처리 검증·게시 |

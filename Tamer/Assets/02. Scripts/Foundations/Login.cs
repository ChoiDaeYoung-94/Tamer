...
public class Login : MonoBehaviour
{
    ...
    void LoginWithPlayFab()
    {
        ...
        var request = new LoginWithGoogleAccountRequest { ServerAuthCode = serverAuthCode/*, CreateAccount = true*/ };
        PlayFabClientAPI.LoginWithGoogleAccount(request, OnLoginWithPlayFabSuccess, OnLoginWithPlayFabFailure);
